...
class Default_contest extends MY_Controller
{
    ...
    {
        $q =  $this->input->get('q', TRUE)?urldecode($this->input->get('q', TRUE)):'';
    ...
    public function winning_information()
    {
        ...
        $config['per_page'] = 10;
        $config['page_query_string'] = TRUE;
        $config['total_rows'] = $this->Default_contest_model->total_rows_contest($id, $q);
        $contest = $this->Default_contest_model->get_limit_data_contest($config['per_page'], $id, $start, $q);
